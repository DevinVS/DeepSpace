...
#include "frc_robot_vision_Pixy2SpiJNI.h"   // Generated
...
JNIEXPORT jboolean JNICALL Java_frc_robot_vision_Pixy2SpiJNI_pixy2SpiInit(JNIEnv *env, jobject thisObj) {
...
JNIEXPORT jobjectArray JNICALL Java_frc_robot_vision_Pixy2SpiJNI_pixy2SpiGetBlocksStrings(JNIEnv *env, jobject thisObj) {
